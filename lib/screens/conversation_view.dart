...
import 'package:stackchat/models/message_model.dart';
...
class _ConversationViewState extends State<ConversationView> {
  ...
  List<ChatMessage> messages = [
    ...
    ChatMessage(
        messageContent: "can you send me your father's photo?",
        messageType: "sender"),
  ];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: appHeadcontainerColor,
